...
public class ExceptionHandlerController {
	...
	@ExceptionHandler(value = org.springframework.web.server.ResponseStatusException.class)
	public ResponseEntity<ErrorMessage> handleResponseStatusException(
		...
		ErrorMessage message = new ErrorMessage(ex.getStatusCode().value(), new Date(), ex.getReason(),
				request.getDescription(false));
