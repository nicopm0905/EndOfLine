...
public class JwtUtils {
	...
	public String generateJwtToken(Authentication authentication) {
		...
		claims.put("avatarId", userPrincipal.getAvatarId());
	...
	public String generateTokenFromUsername(String username, Authorities authority, Integer avatarId) {
		Map<String, Object> claims = new HashMap<>();
		claims.put("authorities", List.of(authority.getAuthority()));
		claims.put("avatarId", avatarId);
